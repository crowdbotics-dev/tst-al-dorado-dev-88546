...
export const api_v1_monster_list = createAsyncThunk(
  "monsters/api_v1_monster_list",
  async payload => {
    const response = await apiService.api_v1_monster_list(payload)
    return response.data
  }
)
export const api_v1_monster_create = createAsyncThunk(
  "monsters/api_v1_monster_create",
  async payload => {
    const response = await apiService.api_v1_monster_create(payload)
    return response.data
  }
)
export const api_v1_monster_retrieve = createAsyncThunk(
  "monsters/api_v1_monster_retrieve",
  async payload => {
    const response = await apiService.api_v1_monster_retrieve(payload)
    return response.data
  }
)
export const api_v1_monster_update = createAsyncThunk(
  "monsters/api_v1_monster_update",
  async payload => {
    const response = await apiService.api_v1_monster_update(payload)
    return response.data
  }
)
export const api_v1_monster_partial_update = createAsyncThunk(
  "monsters/api_v1_monster_partial_update",
  async payload => {
    const response = await apiService.api_v1_monster_partial_update(payload)
    return response.data
  }
)
export const api_v1_monster_destroy = createAsyncThunk(
  "monsters/api_v1_monster_destroy",
  async payload => {
